...
public class DashboardEdit extends Window {
    ...
    private final TextField nameField = new TextField(uiBundle("DashboardEdit.Name"));
    private final DashboardEditListener listener;

    public DashboardEdit(final DashboardEditListener listener,
            final String currentName) {
        this.listener = listener;
        setCaption(uiBundle("DashboardEdit.Caption"));
        setModal(true);
        setClosable(false);
        setResizable(false);
    ...
    private Component buildFooter() {
        ...
        Button cancel = new Button(uiBundle("DashboardEdit.CancelBtn"));
        ...
        Button save = new Button(uiBundle("DashboardEdit.SaveBtn"));
