...
public class ProfilePreferencesWindow extends Window {
    ...
    private Component buildPreferencesTab() {
        ...
        root.setCaption(uiBundle("ProfilePreferencesWindow.PreferencesTab"));
        root.setIcon(FontAwesome.COGS);
        root.setSpacing(true);
        root.setMargin(true);
        root.setSizeFull();

        Label message = new Label(appBundle("APP.NOTIMPLEMENTED"));
    ...
    private Component buildProfileTab() {
        ...
        root.setCaption(uiBundle("ProfilePreferencesWindow.Profile"));
        ...
        Button upload = new Button(uiBundle("ProfilePreferencesWindow.Change"), (ClickEvent event) -> {
    ...
    private Component buildFooter() {
        ...
        Button ok = new Button(MainUI.appBundle("WinClose"));
        ...
        ok.addClickListener((ClickEvent event) -> {
            try {
                ...
                Notification success = new Notification(appBundle("ProfileUpdateOk"));
                ...
                Notification.show(appBundle("ProfileUpdateError"), Type.ERROR_MESSAGE);
            }
        });
        ok.focus();
